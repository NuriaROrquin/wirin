...
static async Task MainAsync(string[] args)
{
    ...
    // En Render no se necesita redirección HTTPS
    ...
    // 👤 Seeder de usuarios, carreras y órdenes
    using (var scope = app.Services.CreateScope())
    {
        ...
        try
        {
            services.GetRequiredService<WirinDbContext>().Database.Migrate();
