        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    userFromId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    responded = table.Column<bool>(type: "bit", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    rangePage = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    FilePath = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    VoluntarioId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AlumnoId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RevisorId = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderTrasability", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "ParagraphAnnotations",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AnnotationText = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreationDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ParagraphAnnotations", x => x.Id);
                });
